...
function enqueue_global_css() {
	wp_enqueue_style('style', get_stylesheet_directory_URI() . '/dist/style.css', array(), '2.0.11');
...
function enqueue_global_js() {
	wp_enqueue_script('app', get_stylesheet_directory_URI() . '/dist/js/app.js', array(), '1.0.24', true);
	if (is_post_type_archive('events') || is_tax('event_type') || is_singular('events')) {
