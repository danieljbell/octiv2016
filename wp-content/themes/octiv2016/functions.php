...
function enqueue_global_css() {
	wp_enqueue_style('style', get_stylesheet_directory_URI() . '/dist/style.css');
}
...
function wpse_100012_override_yoast_breadcrumb_trail( $links ) {
    ...
    if ( is_singular( array('integration', 'catalog') ) || is_post_type_archive( array('integration', 'catalog') ) || is_tax('integration_type') ) {
        $breadcrumb[] = array(
