			...
			<br>
				<div class="half" style="background-color: transparent;">
					<div>
						...
						<p>Click the button if you need assistance from Octiv. If your request is urgent, please call us 24 hours a day for global support: <a href="tel:844-906-2848" style="color: #fff;">844-906-2848</a></p>
					</div>
					<div>
