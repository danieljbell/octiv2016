<div class="newsletter-signup">
	...
	<?php
		...
		elseif ($post->ID === 2279) :
			echo '<div class="centered"><a onclick="ga(\'send\', \'event\', \'Downloads\', \'Ungated WP\', \'E-book downloaded\', \'0\');" href="/wp-content/uploads/2017/02/Unified-Document-Workflows.pdf" class="btn-primary">Read Now</a></div>
			<style>
