  ...
  <div class="site-width">
    <div class="half-only">
      ...
      <div class="two-third-only">
        ...
        <?php endif; ?>
        <?php if ($form_id) : ?>
          <iframe src="http://go.getconga.com/l/217282/2018-04-30/3dmm3" width="100%" height="500" type="text/html" frameborder="0" allowTransparency="true" style="border: 0"></iframe>
        <?php endif; ?>
      </div>
    </div>
  </div>
