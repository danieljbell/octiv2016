...
function cmspo_admin_menu() {
	...
	foreach( $post_types as $post_type ) {
		...
		// Add subpage
		$page = add_submenu_page( 'edit.php?post_type=' . $post_type, apply_filters( 'cmspo_page_label', __( 'Page Order', 'cms-page-order' ), $post_type ), apply_filters( 'cmspo_page_label', __( 'Page Order', 'cms-page-order' ), $post_type ), 'edit_posts', 'order-' . $post_type, 'cmspo_menu_order_page' );
